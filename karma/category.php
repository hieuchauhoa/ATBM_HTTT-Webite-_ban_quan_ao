				...
				<div class="container">
					...
					<div class="collapse navbar-collapse offset" id="navbarSupportedContent">
						<ul class="nav navbar-nav menu_nav ml-auto">
							...
							<li class="nav-item active"><a class="nav-link" href="category.php">Sản phẩm</a></li>
							<?php
								if(isset($_SESSION['isLogin'])){
									if($_SESSION['role']!=3){
		...
		<div class="row">
			<div class="col-xl-3 col-lg-4 col-md-5">
				<div class="sidebar-filter">
					<div class="top-filter-head" style="vertical-align:top">Lọc sản phẩm</div>
					<div class="common-filter">
                    	<br>
						<div class="switch-wrap d-flex justify-content-between filter-list">
							<p><font color="#FF0000">Đang giảm giá</font></p>
					...
					<div class="common-filter">
						<div class="head">Màu sắc</div>
								<div class="switch-wrap d-flex justify-content-between filter-list">
									<p><font color="#000000">Đen</font></p>
									<div class="confirm-switch mr-5">
								...
								<div class="switch-wrap d-flex justify-content-between filter-list">
									<p><font color="#DDD1D1">Trắng</font></p>
									<div class="confirm-switch mr-5">
								...
								<div class="switch-wrap d-flex justify-content-between filter-list">
									<p><font color="#001CF8">Xanh dương</font></p>
									<div class="confirm-switch mr-5">
								...
								<div class="switch-wrap d-flex justify-content-between filter-list">
									<p><font color="#0FA859">Xanh lá</font></p>
									<div class="confirm-switch mr-5">
								...
								<div class="switch-wrap d-flex justify-content-between filter-list">
									<p><font color="#C48103">Nâu</font></p>
									<div class="confirm-switch mr-5">
