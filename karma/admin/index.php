...
<body class="theme-red">
    ...
    <section class="content">
        <div class="container-fluid">
            ...
            <div class="row clearfix">
                ...
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                    <div class="info-box bg-orange hover-expand-effect">
                        ...
                        <div class="content">
                            <div class="text">Người quản trị</div>
            ...
            <!-- CPU Usage -->
            <div>
            <img src="../img/Untitled.png" alt="" style="
    width: 100%;
    height: 400px;
    margin-bottom: 20px
">
                                ...
                                <table class="table table-hover dashboard-task-infos">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>1</td>
                                            <td>Minh Hiếu</td>
                                            <td><span class="label bg-green">5 Sao</span></td>
                                            <td>Rất hài lòng</td>
                                        ...
                                        <tr>
                                            ...
                                            <td>Thùy Dương</td>
                                            <td>
                                                <span class="label bg-red">1 Sao</span>
                                            </td>
                                            <td>Đồ đẹp lắm, 1 sao</td>
                                        ...
                                        <tr>
                                            ...
                                            <td>Phát</td>
                                            <td>
                                                <span class="label bg-yellow">4 Sao</span>
                                            </td>
                                            <td>Anh trai giao hàng dể thương</td>
